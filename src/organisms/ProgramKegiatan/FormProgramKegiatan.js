			...
			<form className="form" onSubmit={handleSubmit(submitForm)}>
				<div className="flex mx-4 py-4 flex-wrap items-center">
					<div className="flex-1 mx-2 sm:mx-4 ">
						<div className=" h-fit p-2 rounded-full  bg-green-500 bg-opacity-30 flex-1">
							{!type && (
					...
					<>
						<div className="flex p-4 -mt-6 sm:p-6 flex-col gap-2">
							{optionsProgram.length > 0 && type !== "program" ? (
								...
								type !== "program" && (
									<p className="text-center text-red-600">
										Belum ada program input program terlebih dahulu
									</p>
								)
							)}
							...
							idProgram ? (
								...
								idProgram && (
									<p className="text-center text-red-600">
										Belum ada kegiatan input kegiatan terlbih dahulu
									</p>
								)
							)}

							{(type == "program" ||
								(type == "kegiatan" && idProgram) ||
								idKegiatan) && (
								<>
